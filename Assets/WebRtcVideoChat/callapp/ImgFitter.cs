...
public class ImgFitter : MonoBehaviour {
    public Renderer resieveTexture;
    public Renderer resieveTexture1;
    ...
    void Update ()
    {
        ...
        if(resieveTexture)resieveTexture.material.mainTexture = image.texture;
        if(resieveTexture1)resieveTexture1.material.mainTexture = image.texture;
