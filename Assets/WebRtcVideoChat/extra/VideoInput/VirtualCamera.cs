...
namespace Byn.Unity.Examples
{
    ...
    public class VirtualCamera : MonoBehaviour
    {
        ...
        [SerializeField]private RenderTexture mRtBuffer = null;
        ...
        private void Awake()
        {
            ...
            if(mRtBuffer==null)mRtBuffer = new RenderTexture(_Width, _Height, 0, RenderTextureFormat.ARGB32);
            else mRtBuffer.width = _Width; mRtBuffer.height = _Height;
